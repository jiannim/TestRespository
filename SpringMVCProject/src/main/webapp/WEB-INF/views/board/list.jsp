...
<style>
	...
	.page-active{background-color: aqua;}
	#count-per-page input[type=button] {background-color: yellowgreen; padding:0px 12px;}
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <c:if test="${articles.size() <= 0}">
                            	<tr>
                            	<td align="center" colspan = "5"> 검색 결과가 없습니다. ㅠㅠ  </td>
                            	</tr>
                            </c:if>
                            ...
                            <tr>
                                ...
                                <td><a href = "<c:url value = "/board/content${pageCreator.makeSearchUri(pageCreator.criteria.page)}
                                &boardNo=${article.boardNo}"/>"> ${article.title} [${article.replyCnt}] </a>
      ...
      <div class="text-center"> 
          <ul class="pagination">                      
              ...
              <li><a href="<c:url value = '/board/list${pageCreator.makeSearchUri(pageCreator.beginPage - 1)}'/>">이전</a></li>  
                                ...
                                <c:forEach var="idx" begin = "${pageCreator.beginPage}" end = "${pageCreator.endPage}" step = "1">
                  <li <c:out value = "${pageCreator.criteria.page == idx ? 'class=active' : ''}"/>><a href="<c:url value = '/board/list${pageCreator.makeSearchUri(idx)}'/>">${idx}</a></li>          <!-- /board/list?page=${idx}&countPerPage=${pageCreator.criteria.countPerPage}  -->                      
                                </c:forEach>
                       ...
                       <div class="col-sm-2"></div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="input-group">
                                <input type="text" class="form-control" name="keyword" id="keywordInput" value="${keyword}" placeholder="검색어">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#searchBtn").on("click", function(){
			self.location = "/mvc/board/list${pageCreator.makePageUri(1)}" + "&condition=" 
