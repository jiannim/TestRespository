                ...
                <form role="form" id="writeForm" method="post" action="<c:url value='/board/modify'/>">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <inpyt type="hidden" name="condition" value="${crie.getCondition}">
                            <inpyt type="hidden" name="Keyword" value="${crie.getKeyword}">
...
<script>
    $(document).ready(function () {
        ...
        $(".listBtn").on("click", function () {
            self.location = "list?page=${page}&countPerPage=${countPerPage}";
        });
